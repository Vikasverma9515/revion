  ...
  return (
    <Boundary label="Eval Lab" animateRerendering={false} kind="solid" color="blue" className="flex flex-col gap-8">
      <PageTitle kicker="Live system" title="Agent, LLM judges and human annotators">
        <p>
          An agent on Groq answers questions, and every question and answer is saved in a local SQLite database. Gemini judges score golden sets or imported sessions against your rubric. Human annotators label the same
